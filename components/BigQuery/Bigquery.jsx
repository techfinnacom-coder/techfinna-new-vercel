...
const Bigquery = () => {
  const schema = {
    ...
    image:
      "https://techfinna.com/images/bigquery/connection.png",
    description:
      "Best module to integrate Odoo with Google BigQuery using our Odoo BigQuery Connector. Streamline your data analytics and business intelligence with seamless connectivity and real-time insights.",
  ...
  const meta = {
    title:
      "Odoo BigQuery Connector Module - Best Seller",
    desc: "Best module to integrate Odoo with Google BigQuery using our Odoo BigQuery Connector. Streamline your data analytics and business intelligence with seamless connectivity and real-time insights.",
    url: "https://techfinna.com/odoo-bigquery-connector/",
  };
  return (
    <>
      ...
      {/* <Helmet>
        <title> Google Big Query Connector | TechFinna</title>
        <meta
          name="description"
          content="Transform the way you handle data in Odoo with our standalone BigQuery Connector. Designed to integrate seamlessly with Google BigQuery, this powerful tool unlocks new dimensions in data analysis and visualization. Streamline your data processes and make informed decisions with ease and confidence."
        />
        <meta
          name="keywords"
          content="Odoo BigQuery Connector Integration Data synchronization ETL (Extract, Transform, Load) Data warehousing Cloud computing Business intelligence Data analytics Real-time reporting ERP (Enterprise Resource Planning) SQL (Structured Query Language) Python"
        />
        <link rel="canonical" href="https://techfinna.com/bigquery-connector" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Odoo Bigquery connector" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://techfinna.com/bigquery-connector"
        />
      </Helmet> */}
      ...
      <div className="md:mx-32 mx-5 text-black pt-20 space-y-48 md:my-28">
        <div className="flex flex-col-reverse md:flex-row h-full gap-32 w-full">
          ...
          <div className="border h-min p-10 rounded-md drop-shadow-xl duration-300 md:sticky top-20 bottom-0 items-center flex flex-col gap-y-10 w-full md:w-[350px]">
            ...
            <div className="flex flex-col gap-3">
              <Link
                target="_blank"
                href="/payment/google-bigquery-connector/"
              >
              ...
              >
                <button className="p-1 rounded-md shadow-lg border-[#285a9b] border-2 text-[#285a9b] w-[250px]  text-center text-xl font-semibold">
                  Installation Guide
                </button>
              </Link>
