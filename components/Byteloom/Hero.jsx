...
const price = amount;
  ...
  return (
    <div className="flex w-full justify-center items-center mt-10 md:mt-0">
      <div className="absolute hidden md:block w-full h-[500px] bg-gray-400 top-0 left-0 z-0" />
      <div className="flex flex-col lg:flex-row justify-evenly items-start z-[10] w-full lg:w-[85%] mx-auto">
        ...
        <div className="videocontainer flex flex-col justify-start items-start w-full lg:w-[60%]">
          <div className="drop-shadow-xl flex items-center flex-col relative w-full">
            <div className="flex items-center flex-row rounded-t-md w-full bg-gray-900 min-h-[20px] py-1.5 px-3">
              <div className="w-[12px] mr-2 h-[12px] rounded-full bg-red-500" />
              <div className="w-[12px] mr-2 h-[12px] rounded-full bg-yellow-500" />
              <div className="w-[12px] h-[12px] rounded-full bg-green-500" />
              <div className="flex-1" />
            </div>
            <div className="relative h-full w-full rounded-b-sm min-h-[350px] bg-white flex justify-center items-center p-4">
              <img
                loading="lazy"
                src="/images/aiPowered/banner.png" /* replace if your asset path differs */
                alt="AI Powered Dashboard using Odoo data"
                width={700}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start mt-12 w-full">
            ...
            <h2 className="text-medium text-black mt-2 mb-4">
              Connect Odoo data to get AI-built dashboards with recommended KPI’s and visuals. Edit charts, apply filters, and ask questions in plain language to explore insights. No coding required or SQL needed!
            </h2>
            ...
            <div className="flex justify-center items-center py-1">
              ...
              <div className="flex gap-1 flex-wrap text-black ml-[6px]">
                {["15.0", "16.0", "17.0", "18.0", "19.0"].map((v) => (
                  <p
                    key={v}
                    className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium"
                  >
                    {v}
                  </p>
                ))}
            ...
            <div className="flex py-1">
              <span className="font-semibold pr-2">Validity:</span> Free First Month
            </div>

            <div className="flex py-1">
              <span className="font-semibold pr-2">Product Copyright:</span>
              <a className="underline text-gray-700" href="/about">
                TechFinna
              </a>
            </div>

            {/* Odoo Apps listing link */}
            <a
              target="_blank"
              ...
              href="https://apps.odoo.com/apps/modules/19.0/byteloom_generative_dashboard"
            >
              {/* (icon svg omitted) */}
            ...
            <div className="p-8 z-[10] shadow-xl bg-white rounded-xl w-full max-w-[400px] drop-shadow-lg flex flex-col justify-center items-center gap-2">
              ...
              <div className="flex flex-col w-full justify-center items-center">
                <div className="w-full flex flex-col justify-start items-start gap-1 my-4">
                  <a
                    href="https://www.youtube.com/watch?v=tauMW2vFcP8&t=6s"
                  ...
                  <p className="gap-2 flex justify-center items-center">
                    ...
                    <span className="flex items-center">
                      AI<span className="text-sky-700 pl-1">Automation and Chatbot</span> 
                    </span>
                  </p>
              ...
              <a
                href='https://apps.odoo.com/apps/modules/19.0/byteloom_generative_dashboard'
                className="text-gray-800 font-semibold w-[80%] text-center flex justify-center items-center border-indigo-700 border-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-indigo-200 disabled:cursor-wait disabled:opacity-50 rounded-lg text-base px-5 py-2.5"
              >
                Try for Free
              </a>
              ...
              <a
                href="https://apps.odoo.com/apps/modules/19.0/byteloom_generative_dashboard"
                className="text-white w-[80%] text-center flex justify-center items-center bg-indigo-700 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-indigo-200 disabled:cursor-wait disabled:opacity-50 rounded-lg text-base px-5 py-2.5"
              >
                 <svg
             ...
             {/* <div className="flex justify-center items-center flex-col mt-10 ">
              ...
              <div className="flex items-center flex-col sm:h-[285px] sm:w-[450px] lg:h-[200px] lg:w-[300px] relative border-sm">
                <div className="flex justify-center items-center relative h-full w-full rounded-b-sm">
                  <a
                    href="https://www.youtube.com/watch?v=CV_P9oVIdno"
                  ...
                  >
                    ...
                    <img
                      ...
                      width="500px"
                      height="450px"
                      src="\images\pbi-cloud\videoThumbnail.jpg"
                    />
                  </a>
                </div>
              </div>
