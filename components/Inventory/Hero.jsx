// Hero.jsx  (text-only edits, UI intact)
        ...
        <div className="videocontainer flex flex-col justify-start items-start w-full lg:w-[60%]">
          <div className="drop-shadow-xl flex items-center flex-col relative w-100 ">
            ...
            <div className=" relative h-full w-full rounded-b-sm">
              <img
                loading="lazy"
                className=""
                src="/images/inventory/banner1.gif"
                alt="best seller"
                width="700"
              />
            </div>
          ...
          <div className="flex flex-col justify-start items-start mt-6 w-full">
            <h1 className="text-3xl xl:text-4xl font-semibold text-black">
              Odoo Inventory Forecasting - One Click RFQ Creation
            </h1>
            <h2 className="text-medium text-black mt-2 mb-4">
              Plan demand sales total for your future sales. Create Request For Quotation in a single click for vendors
            </h2>

            <div className="flex justify-center items-center py-1">
              <span className="font-semibold mr-4">Odoo Versions:</span>
              <div className="flex gap-1 flex-wrap text-black ml-[6px]">
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">12.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">13.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">14.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">15.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">16.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">17.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">18.0</p>
                <p className="text-sm bg-[#EDF2F7] rounded-sm px-2 border font-medium">19.0</p>
            ...
            <div className="flex py-1">
              ...
              <a className="underline font-gray-400 !font-light" href="/about">TechFinna</a>
            </div>

            <div className="flex py-1 ">
              <span className="font-semibold pr-2">License: </span>
              <p className="pt-[2px] text-sm">LGPL-3</p>
            </div>
        ...
        <div className="flex flex-col mt-6 md:mt-0 text-center justify-center items-center lg:justify-end lg:items-end w-full lg:w-[40%] relative">
          <div className="flex flex-col justify-center items-center">
            <div className=" p-8 z-[10] shadow-xl  bg-white rounded-xl w-full max-w-[400px] drop-shadow-lg flex flex-col justify-center items-center gap-2">
              <div className="flex justify-between w-full  border-b-2 border-gray-500 pb-4 gap-2 items-end">
                <div className="mt-1 inline-flex items-center justify-end">
                  <div className="-mt-px mr-1.5 flex-shrink-0 text-base font-bold">4.9</div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 -0.5 32 32" fill="none">
                  ...
                  <a href="#reviews" className="mx-3 flex-shrink-0 text-[0.8rem] font-medium text-gray-600">
                    (85 ratings)
                  </a>
                </div>
              ...
              <div className="flex flex-col w-full justify-center items-center">
                <div className="w-full flex flex-col justify-start items-start gap-1 my-4">
                  <a
                    href="https://www.youtube.com/watch?v=mc_yw7OG8Hc"
                    className="gap-2 flex justify-center items-center"
                  >
                    <span>
                      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024"
                        className="inline h-[20px] w-[20px]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="gap-2 flex justify-center items-center">
                    <span>
                      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24"
                        className="inline h-[20px] w-[20px]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 12h2v7H3zM19 5h2v14h-2zM11 8h2v11h-2zM7 10h2v9H7zM15 3h2v16h-2z"></path>
                      </svg>
                    </span>{" "}
              ...
              <div className="flex  justify-center items-center">
                <a href="https://wa.me/916230927667" className="border-2 border-green-800 rounded-lg">
              ...
              <div className="flex flex-col gap-2 justify-center items-center">
                ...
                <div className="flex mt-4 justify-center items-center gap-2">
                  <div className="flex h-8 max-w-full items-center justify-center p-2 ">
                    <img loading="lazy" alt="Mastercard" width="42" height="22" decoding="async" data-nimg="1" className="object-contain"
                  ...
                  <div className="flex h-8 max-w-full items-center justify-center p-2 ">
                    <img loading="lazy" alt="Discover Card" width="56" height="28" decoding="async" data-nimg="1" className="object-contain"
                      src="/images/payment/discoveryCard.webp"
                    />
                  </div>
                  <div className="flex h-8 max-w-full items-center justify-center p-2 ">
                    <img loading="lazy" alt="Visa Payment Card" width="56" height="28" decoding="async" data-nimg="1" className="object-contain"
                      src="/images/payment/visa-icon.svg"
                    />
                  </div>
                  <span className="text-gray-500 underline text-sm underline-offset-4">& many more</span>
                </div>
              </div>
            ...
            {/* <div className="flex justify-center items-center flex-col mt-10 ">
              <h2 className="text-3xl md:text-2xl text-black mb-5">Watch Demo</h2>
              <div className="flex items-center flex-col sm:h-[285px] sm:w-[450px] lg:h-[200px] lg:w-[300px] relative border-sm">
                <div className="flex justify-center items-center relative h-full w-full rounded-b-sm">
                  ...
                  >
                    ...
                    <img className="img-responsive" alt="inventory forecasting module" width="500px" height="450px" src="\images\inventory\inventoryBanner.jpg" />
                  </a>
                </div>
              </div>
            </div> */}
