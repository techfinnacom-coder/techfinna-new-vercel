...
const Hero = () => {
  ...
  return (
    <div className=" relative w-full flex-col pt-[60px] ">
      ...
      <div className=" relative z-10 bg-transparent text-black md:px-20 pt-[60px] ">
        <section className="">
          <div className="flex text-center flex-col justify-center items-center py-4 pt-8 px-4 mx-auto max-w-screen-xl text-center  lg:px-12">
            <a href="#searchProducts">
              <span className="flex gap-2 rounded-full w-fit font-sans mb-4 uppercase bg-gray-800 px-4 tracking-wide py-2 text-sm font-semibold leading-5 text-white">
                Powerful KPI's{" "}
                <svg
            ...
            <h1 className="mb-4 text-4xl tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl ">
            ...
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
              Here at Techfinna, get comprehensive
              insight of odoo data. Increase
              productivity by 10x times.
            </p>
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              <a
                href="https://apps.odoo.com/apps/modules/browse?author=TechFinna"
              ...
              <a
                href="https://www.youtube.com/@tech-finna"
        ...
        <div
          className="overflow-hidden  px-4 w-full relative "
          id="perspectiveDiv"
        >
          <div
            className={
              activeClass
                ? "relative w-[100%] overflow-x-hidden md:w-3/4 mx-auto h-[12rem] sm:h-[16rem] md:h-[24rem] lg:h-[32rem] -mb-12 md:-mb-22 max-w-5xl transitionClass transformDivBack"
                : "relative w-[100%] overflow-x-hidden md:w-3/4 mx-auto h-[12rem] sm:h-[16rem] md:h-[24rem] lg:h-[32rem] -mb-12 md:-mb-22 max-w-5xl transitionClass transformDiv"
            }
          >
            <img
              decoding="async"
              ...
              loading="lazy"
              data-nimg="fill"
              className=" absolute h-full w-full inset-0 text-transparent transition duration-500 blur-0 scale-100 rounded-xl md:rounded-3xl border mx-auto object-cover shadow-sm object-right-top"
              sizes="100vw"
