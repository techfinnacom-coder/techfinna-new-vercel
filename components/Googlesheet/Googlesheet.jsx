...
const Googlesheet = () => {
  ...
  const meta = {
    title:
      "Google Spreadsheet Connector - Techfinna",
    desc: "Unlock the full potential of your data with the Google Spreadsheet Odoo Connector. Easily sync data between Odoo and Google Sheets in just two clicks. Experience real-time updates, rapid table selection, and more. Connect, choose your data, and gain full control over your Odoo tables in Sheets. Continuous innovation and free updates.",
  ...
  return (
    <>
      ...
      <Head>
        <title>
          Spreadsheet Odoo Connector | TechFinna
        </title>
        <meta charset="UTF-8" />
        <meta
          name="viewport"
        ...
        <meta
          name="description"
          content="Unlock the full potential of your data with the Google Spreadsheet Odoo Connector. Easily sync data between Odoo and Google Sheets in just two clicks. Experience real-time updates, rapid table selection, and more. Connect, choose your data, and gain full control over your Odoo tables in Sheets. Continuous innovation and free updates."
        />
        <meta
          name="keywords"
          content="Google Spreadsheet Odoo Connector, Data Sync, Two Clicks, Real-Time Updates, Table Selection, One-Time Setup, Step-by-Step Guide, Full Data Control, Continuous Innovation, Feature Requests, Techfinna"
        />
          ...
          <div>
            <div className="border p-10 rounded-md drop-shadow-xl duration-300 sticky top-20 bottom-0 items-center flex flex-col gap-y-10 w-full md:w-[350px]">
              ...
              <div className="flex flex-col gap-3">
                <Link
                  target="_blank"
                  href="/payment/odoo-spreadsheet-connector/"
                >
                ...
                <Link
                  target="_blank"
                  href="/guides/how-to-connect-google-spreadsheet-with-odoo/"
                >
