...
const QlikConnector = () => {
  const schema = {
    ...
    name: "Odoo Qlik Connector",
    url: "https://techfinna.com/odoo-qlik-connector/",
    description:
  ...
  const meta = {
    title:
      "Odoo Power BI Direct Connector - Techfinna",
    desc: "Unlock the full potential of your Odoo data with the seamless integration of TechFinna's Odoo PowerBI Connector. Gain deeper insights, streamline reporting, and drive informed decisions effortlessly",
    url: "https://techfinna.com/odoo-powerbi-connector/",
  };
  const showModal = () => {
    document
      .getElementById("modalId")
      .classList.add("z-[99999]");
    document
      .getElementById("modalId")
        ...
        <div className="flex flex-col-reverse md:flex-row h-full gap-32 w-full">
          ...
          <div className="border h-min p-10 rounded-md drop-shadow-xl duration-300 md:sticky top-20 bottom-0 items-center flex flex-col gap-y-10 w-full md:w-[650px]">
            ...
            <div className="flex flex-col gap-3">
              <Link
                target="_blank"
                href="/payment/odoo-qlik-connector/"
              >
              ...
              <Link
                target="_blank"
                href="https://apps.odoo.com/apps/modules/17.0/qlik_connector"
              >
