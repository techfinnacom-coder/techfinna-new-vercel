        ...
        <div className="videocontainer flex flex-col justify-start items-start w-full lg:w-[60%]">
          <div className="drop-shadow-xl flex items-center flex-col relative w-full">
            ...
            <div className="relative h-full w-full rounded-b-sm min-h-[350px] bg-white flex justify-center items-center p-4">
              <img
                loading="lazy"
                src="/images/pbi-cloud/banner.png" /* replace if your asset path differs */
                alt="Power BI Cloud Connector with AI banner"
                width={700}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start mt-12 w-full">
            <h1 className="text-3xl xl:text-4xl font-semibold text-black">
              PowerBI Cloud Connector with AI — Build One Dataset, Not Ten Tables
            </h1>
            <h2 className="text-medium text-black mt-2 mb-4">
              Create a clean dataset inside Odoo, live-preview rows as you pick fields,
              then push to Power BI Cloud. AI drafts your first dashboard.
            </h2>
            ...
            <a
              ...
              href="https://apps.odoo.com/apps/modules/19.0/pbi-cloud-ai"
            >
              {/* (icon svg omitted) */}
                ...
                <div className="w-full flex flex-col justify-start items-start gap-1 my-4">
                  ...
                  <p className="gap-2 flex justify-center items-center">
                    ...
                    <span className="flex items-center">
                      <span className="text-sky-700 pr-1">Power BI</span> Service Compatible
                    </span>
                  </p>
