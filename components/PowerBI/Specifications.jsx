      ...
      <div className="flex flex-col w-full text-left justify-start items-start">
        ...
        <div className="mt-12 flex flex-col md:flex-row gap-4 lg:px-14">
          <ul className="space-y-3 ">
            ...
            <li className="text-body-color dark:text-dark-6 flex text-base">
              ...
              New level of visualizing dashboards
            </li>
        ...
        <div className=" mt-12 p-1 flex flex-wrap lg:px-4 gap-6 items-center justify-center my-6">
          <div className="h-full min-h-[220px] md:min-h-[280px] lg:max-w-[280px] xl:max-w-[330px] flex flex-col justify-center items-center p-6 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
            ...
            <p className="mb-3 font-normal text-gray-500 text-center dark:text-gray-400">
              One click installation for setting
              up this connector in your desktop
              environment
            </p>
          </div>
        ...
        <div className="mt-6 w-full md:w-[80%] mx-auto">
          ...
          <p className="text-xl text-center">
            Techfinna proudly unveils the
            industry's first and only Odoo to
            Power BI Connector, a pioneering tool
            for smooth data integration. This
            exclusive connector revolutionizes the
            process of linking Odoo data with
            Power BI, offering a simple, one-step
            solution for seamless access to all
            your Odoo tables. Just enter your
            generated credentials, select the
            tables you need, and our connector
            will handle the rest, ensuring precise
            schemas and data are delivered
            directly into Power BI. With
            Techfinna, enjoy the flexibility of
            manual refreshes or enhance your data
            management with our premium scheduled
            refresh option. Discover the ease and
            efficiency of Techfinna's connectors,
            setting new standards for Odoo
            integrations with Power BI, Looker
            Studio, BigQuery, and Google Sheets.
          </p>
        </div>
        <div className=" mt-12 flex flex-col w-full items-center justify-center">
            <img className="fluid shadow-xl" width='60%' src="/images/powerbi/benchmark.jpeg"/>
        </div>
