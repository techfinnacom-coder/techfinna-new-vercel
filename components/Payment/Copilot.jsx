...
const Copilot = () => {
  ...
  return (
    <div className="w-[90%] md:w-[80%] mx-auto flex flex-col md:flex-row justify-center items-center mt-[60px]">
      <div className="flex flex-col w-full md:w-1/2 bg-white py-10 md:py-2 px-6 md:px-24">
        ...
        <p className="text-gray-500 mt-10">
          Copyright TechFinna © 2026. All rights reserved by TechFinna.
        </p>
      </div>
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-gray-100 py-12 min-h-screen px-4 ">
        <a
          href="/"
        ...
        >
          <CheckoutPage amount={amount} productName={`mcp_copilot`} />
        </Elements>
      </div>
    </div>
  );
