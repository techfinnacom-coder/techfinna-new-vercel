...
const PowerBI = () => {
  const reviews = [
    ...
    },
    {
      ...
      position: "CTO",
      description:
        "Great app and excellent on customer support",
    },
    {
      id: "3",
  ...
  const currentProduct = products.filter(
    (obj) => obj.href == "/powerbi-sql-connector/"
  );
      ...
      <div className="flex flex-col w-full md:w-1/2 bg-white py-10 md:py-2 px-6 md:px-24">
        <div className="flex items-center space-x-4 pb-4 text-left text-black">
          ...
          <div className="flex-grow">
            ...
            >
              Odoo PowerBI SQL Connector
            </h3>
            <div className="mt-1 text-sm">
              Execute Custom SQL Queries using
              this add-on module
            </div>
          </div>
        </div>
        ...
        <div
          id="testimony"
          className="md:py-10  items-center "
        >
            ...
            <div className=" rounded-lg py-6">
              <Swiper
                ...
                modules={[
                  ...
                  Navigation,
                  Autoplay,
                ]} // Include the Navigation and Autoplay modules
        ...
        <p className="text-gray-500 mt-10">
          Copyright TechFinna © 2024. All rights
          reserved by TechFinna.
        </p>
      </div>
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-gray-100 py-12 text-red-500 px-4 ">
        {/* <a
          href="/"
