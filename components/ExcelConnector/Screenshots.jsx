...
export default function Screenshots() {
  const data = [
    {
      step: "1. Create Odoo Connection",
      context: `To connect, enter your Odoo Backend URL and Access Token into the taskpane interface.`,
      content: (
    ...
    {
      step: "2. Fetch data by tables",
      context: `Search & select odoo tables to fetch`,
      content: (
    ...
    {
      step: "3. Run custom SQL query",
      context: `Execute custom SQL query and add a new sheet`,
      content: (
        <div className="my-2 flex flex-col gap-4">
          <img
            className="shadow-lg"
      ...
      <div className="w-full flex flex-col w-full text-left justify-start items-start">
        <div className="max-w-7xl  px-4 md:px-8 lg:px-10">
          ...
          <div className="flex flex-wrap gap-4 md:justify-center md:items-center md:pl-2 mt-4 text-xl">
            ...
            <span>with</span>
            <img
              src="/images/excel-connector/excel-logo.png"
              width={"60px"}
              alt="odoo tableau connector"
            />
          </div>
